            ...
            <div className="nature-card rounded-2xl p-5 border-l-4 border-yellow-500">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-800">Draw Your Area of Interest</p>
                  <p className="text-sm text-gray-600 mt-1">Switch to the Base Map tab and draw a polygon, rectangle, or circle to define your analysis area.</p>
                </div>
              </div>
            </div>
          )}
