          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-3">
              ...
              >
                ...
                <span className="text-xs">{hasDrawnArea || hasLoadedData ? '🤖 AI Analyze' : '📍 Draw Area'}</span>
              </button>
            </div>
          </div>
            ...
            <div className="nature-card rounded-2xl p-5 border-l-4 border-green-500">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Satellite data is now displayed. You can download as PNG/TIFF or clear all to start fresh.</p>
                </div>
              </div>
            </div>
          )}
