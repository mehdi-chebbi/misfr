...
<section className="relative h-[93vh]">
  ...
  >
    ...
    >
      ...
      >
        <span className="text-white drop-shadow-2xl">Misbar Africa</span>
        <motion.span 
      ...
      >
        <Link
          href="/journey"
          className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-12 py-6 rounded-3xl font-bold text-xl hover:scale-105 transition-all duration-300 shadow-2xl group flex items-center space-x-3"
        >
