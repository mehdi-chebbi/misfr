  ...
  const handleAnalyzeWithAI = async () => {
    ...
    try {
      ...
      if (imageMetadata) {
        ...
        console.log('Sending satellite image to AI for analysis:', wmsUrl)

        // Call the new satellite analysis endpoint
        const response = await fetch('http://localhost:5000/api/vision/analyze_satellite', {
          method: 'POST',
          headers: {
