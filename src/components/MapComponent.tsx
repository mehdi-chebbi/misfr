    ...
    try {
      ...
      if (imageMetadata) {
        ...
        setConversationHistory([{
          ...
          content: "I have drawn an area on the map. What kind of analysis can you help me with?"
